...
(defun benjaminhao-advice-remove-button (function)
...
(advice-add 'describe-function-1 :after #'benjaminhao-advice-remove-button)

(defun benjaminhao-ag-edit (function)
...
;; (defun benjaminhao-after-ag-edit (function)
;;   (ivy-occur-grep-mode))

(advice-add 'helm-ag--edit :before #'benjaminhao-ag-edit)
;; (advice-add 'helm-ag--edit :after #'benjaminhao-after-ag-edit)
